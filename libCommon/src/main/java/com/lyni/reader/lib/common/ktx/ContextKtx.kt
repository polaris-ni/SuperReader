...
import com.lyni.reader.lib.common.utils.IntentHelp
import com.lyni.reader.lib.common.utils.IntentType
...
import com.lyni.treasure.lib.common.utils.showLongToast
import java.io.File
...
val Context.sysScreenOffTime: Int
    get() {
        return kotlin.runCatching {
            ...
            Log.e("ContextKtx", "sysScreenOffTime: Failure", it)
        }.getOrDefault(0)
    }
...
fun Context.share(file: File, type: String = "text/*") {
    val fileUri = FileProvider.getUriForFile(this, Constants.authority, file)
    val intent = Intent(Intent.ACTION_SEND)
    intent.type = type
...
fun Context.sendToClip(text: String) {
    ...
    showLongToast(R.string.copy_complete.getString)
}
...
fun Context.sendMail(mail: String) {
    try {
        ...
        ToastUtil.showToast(e.localizedMessage ?: "Error")
    }
}
...
fun Context.openUrl(url: String) {
    try {
        ...
        ToastUtil.showToast(e.localizedMessage ?: "open url error")
    }
}
