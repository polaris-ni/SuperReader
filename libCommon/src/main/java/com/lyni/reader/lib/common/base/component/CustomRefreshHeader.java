...
public class CustomRefreshHeader extends FrameLayout implements RefreshHeader {
    ...
    private void initView(Context context, AttributeSet attrs) {
        @SuppressLint("CustomViewStyleable") TypedArray array = getContext().obtainStyledAttributes(attrs, R.styleable.CustomRefresh);
        assetsFileName = array.getString(R.styleable.CustomRefresh_assetsName);
        array.recycle();
