...
import com.lyni.reader.lib.common.base.interfaces.ListPageListener
import com.lyni.reader.lib.common.base.viewmodel.BaseListViewModel
import com.lyni.treasure.lib.common.ktx.otherwise
import com.lyni.treasure.lib.common.ktx.positive
 ...
 */
abstract class BaseListFragment<VB : ViewBinding, VM : BaseListViewModel<T>, T : Any> : BaseFragment<VB, VM>(), ListPageListener<T> {
    ...
    override fun layoutManager(): RecyclerView.LayoutManager = mRecyclerView.layoutManager ?: LinearLayoutManager(context)
    ...
    override fun initLiveData() {
        super.initLiveData()
        viewModel.getListDataLive().observe(this) {
            // 没有数据显示空态，否则回调数据加载函数
